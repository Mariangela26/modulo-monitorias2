package com.unisimon.monitorias.databuilder.users;
...
public class InfoUserPerfilesTestDataBuilder {
    ...
    public static final List<PerfilePhoto> FOTOGRAFIAS = new ArrayList<PerfilePhoto>();
    ...
    private List<PerfilePhoto> fotografias;

    public InfoUserPerfilesTestDataBuilder(){
