...
import com.pragma.store.databuilder.chapter.InfoSeniorityMonthConsultTestDataBuilder;
...
class GetInfoSeniorityMonthTest {
    ...
    void testExecuteGetInfoSeniorityMonths() throws Exception{
        ...
        UriComponents uri = UriComponentsBuilder
                ...
                .build();
        when(handlerGetInfoSeniorityMonths.execute(chapterId, month))
                .thenReturn(new ObjectResponse<>(infoSeniorityMonthConsults));
